...
{
    public static BlockEntityType<BaseFurnaceEntity> FABRIC_FURNACE = BlockEntityType.Builder.create(() -> new BaseFurnaceEntity(Entities.FABRIC_FURNACE, 1, 1, 0)).build(null);
    public static BlockEntityType<CrystalFurnaceEntity> CRYSTAL_FURNACE = BlockEntityType.Builder.create(() -> new CrystalFurnaceEntity(1, 1, 0)).build(null);
